...
function showNotification() {
  ...
  namaElement.textContent = getRandomElement(namaPem);
  kotaElement.textContent = getRandomElement(kota) + ", Indonesia";
  paketElement.textContent = getRandomElement(r_product);
  waktuElement.textContent = getRandomTime() + " menit yang lalu";
...
function autoShowAndHideNotification() {
  setTimeout(function () {
    ...
    setTimeout(function () {
      // Memanggil closeNotification setelah DOM sepenuhnya dimuat
      document.addEventListener("DOMContentLoaded", function () {
        closeNotification();
      });
