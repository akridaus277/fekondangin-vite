...
const LandingPage = () => {
  ...
  const testimonialData = [
    {
      name: 'John & Jane',
      image: './src/main/assets/img/about/about.png',
      domain: 'example.com',
  ...
  return (
   ...
   <>
      {/* <link href="./src/main/assets/vendor/aos/aos.css" rel="stylesheet"></link> */}
      {/* <link href="./src/main/assets/css/style.css" rel="stylesheet"></link>
      <link href="./src/main/assets/notif/style.css" rel="stylesheet"></link>
      <link href="./src/main/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet"></link>
      <link href="./src/main/assets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet"></link>
      <link href="./src/main/assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet"></link>
      <link href="./src/main/assets/vendor/glightbox/css/glightbox.min.css" rel="stylesheet"></link>
      <link href="./src/main/assets/vendor/remixicon/remixicon.css" rel="stylesheet"></link> */}
      <div>
        ...
        <header id="header" className="sticky-top d-flex align-items-center">
          <div id='home' className="container d-flex align-items-center justify-content-between">
            <div className="logo">
              ...
              {/* <a href="index.html"><img src="./src/main/assets/img/logo.png" alt="" className="img-fluid"></a>*/}
            </div>
            <nav id="navbar" className="navbar ">
              <ul>
                ...
                {/* <li><a className="nav-link scrollto" href="blog.html">Blog</a></li> */}
...

                {
                  token ? (<Link>
                    ...
                    <Button type="primary" shape="round" size='large' onClick={() => { window.location.assign('/member-area') }}>
                      Login
                    </Button>
                  </Link>)
                }
            ...
            <div className="row">
              <div className="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                ...
                <div data-aos="fade-up" data-aos-delay={800}>
                  ...
                  {/* <a href="#about" className="btn-get-started scrollto" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Get Started</a> */}
                </div>
              </div>
              <div className="col-lg-6 order-1 order-lg-2 d-flex justify-content-center" data-aos="fade-left" data-aos-delay={200}>
                {/* <video src="https://wedew.id/themes/wedew-public/./src/main/assets/images/hero.mp4" loading="eager" autoPlay loop playsInline muted style={{ width: 337, objectFit: 'contain' }} /> */}
                <img src="./src/main/assets/img/video/hero.webp" style={{ width: '337px', justifyContent: 'center', objectFit: 'contain' }} />
              </div>
            </div>
          </div>
        </section>{/* End Hero */}
...
<div className="container">
  ...
  <div className="row">
    <div className="col-lg-2 col-md-4 col-6">
      <img src="./src/main/assets/img/clients/client-1.png" className="img-fluid" alt="" data-aos="zoom-in"/>
    </div>

    <div className="col-lg-2 col-md-4 col-6">
      <img src="./src/main/assets/img/clients/client-2.png" className="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="100"/>
    </div>

    <div className="col-lg-2 col-md-4 col-6">
      <img src="./src/main/assets/img/clients/client-3.png" className="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="200"/>
    </div>

    <div className="col-lg-2 col-md-4 col-6">
      <img src="./src/main/assets/img/clients/client-4.png" className="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="300"/>
    </div>

    <div className="col-lg-2 col-md-4 col-6">
      <img src="./src/main/assets/img/clients/client-5.png" className="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="400"/>
    </div>

    <div className="col-lg-2 col-md-4 col-6">
      <img src="./src/main/assets/img/clients/client-6.png" className="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="500"/>
    </div>
            ...
            <div className="container">
              <div className="row">
                <div className="image col-xl-5 d-flex align-items-stretch justify-content-center justify-content-xl-start" data-aos="fade-right" data-aos-delay={150}>
                  <img src="./src/main/assets/img/about/about.png" alt className="img-fluid" />
                </div>
...
<div className="container">
  ...
  <div className="row">
    <div className="col-md-6 d-flex align-items-stretch">
      <div className="card" style='background-image: url("./src/main/assets/img/more-services-1.jpg");' data-aos="fade-up" data-aos-delay="100">
    ...
    <div className="col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
      <div className="card" style='background-image: url("./src/main/assets/img/more-services-2.jpg");' data-aos="fade-up" data-aos-delay="200">
        <div className="card-body">
    ...
    <div className="col-md-6 d-flex align-items-stretch mt-4">
      <div className="card" style='background-image: url("./src/main/assets/img/more-services-3.jpg");' data-aos="fade-up" data-aos-delay="100">
        <div className="card-body">
    ...
    <div className="col-md-6 d-flex align-items-stretch mt-4">
      <div className="card" style='background-image: url("./src/main/assets/img/more-services-4.jpg");' data-aos="fade-up" data-aos-delay="200">
        <div className="card-body">
            ...
            <div className="container">
              ...
              <div className="row" data-aos="fade-up" data-aos-delay={300}>
                ...
                <div className="col-lg-3 col-md-4 mt-4">
                  <div className="icon-box">
                    <i className="bi bi-envelope-heart" style={{ color: '#47aeff' }} />
                    <i className='bx bx-message-alt-edit' style={{ color: 'rgb(225, 69, 95)' }}></i>
                ...
                <div className="col-lg-3 col-md-4 mt-4">
                  <div className="icon-box">
                    ...
                    <i className='bx bx-broadcast' style={{ color: '#47aeff' }}></i>
                ...
                <div className="col-lg-3 col-md-4 mt-4">
                  <div className="icon-box">
                    {/* <i className="bi bi-envelope-heart" style={{ color: '#47aeff' }} /> */}
                    <i className='bx bx-book-open' style={{ color: 'rgb(225, 69, 95)' }}></i>
                    <h3><a href>RSVP</a></h3>
                  </div>
                </div>
                <div className="col-lg-3 col-md-4 mt-4">
                  <div className="icon-box">
                    {/* <i className="bi bi-envelope-heart" style={{ color: '#47aeff' }} /> */}
                    <i className='bx bx-info-circle' style={{ color: '#47aeff' }} ></i>
              ...
              <div className="row portfolio-container" data-aos="fade-up" data-aos-delay={400}>
                <div className="col-lg-4 col-md-6 portfolio-item filter-app">
                  <div className="portfolio-wrap">
                    <img src="./src/main/assets/img/bronze/a.jpg" className="img-fluid" alt />
                    <div className="portfolio-info">
                      <h4>Bronze Satu</h4>
                      <p>Preview</p>
                      <div className="portfolio-links">
                        <a href="./src/main/assets/img/bronze/a.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="App 1"><i className="bx bx-plus" /></a>
                ...
                <div className="col-lg-4 col-md-6 portfolio-item filter-app">
                  <div className="portfolio-wrap">
                    <img src="./src/main/assets/img/bronze/Bronze2.jpg" className="img-fluid" alt />
                    <div className="portfolio-info">
                      <h4>Bronze Dua</h4>
                      <p>Preview</p>
                      <div className="portfolio-links">
                        <a href="./src/main/assets/img/bronze/Bronze2.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Web 3"><i className="bx bx-plus" /></a>
                ...
                <div className="col-lg-4 col-md-6 portfolio-item filter-app">
                  <div className="portfolio-wrap">
                    <img src="./src/main/assets/img/bronze/Bronze3.jpg" className="img-fluid" alt />
                    <div className="portfolio-info">
                      <h4>Bronze Tiga</h4>
                      <p>Preview</p>
                      <div className="portfolio-links">
                        <a href="./src/main/assets/img/bronze/Bronze3.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="App 2"><i className="bx bx-plus" /></a>
                ...
                <div className="col-lg-4 col-md-6 portfolio-item filter-card">
                  <div className="portfolio-wrap">
                    <img src="./src/main/assets/img/silver/silver1.jpg" className="img-fluid" alt />
                    <div className="portfolio-info">
                      <h4>Silver Satu</h4>
                      <p>Preview</p>
                      <div className="portfolio-links">
                        <a href="./src/main/assets/img/silver/silver1.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Card 2"><i className="bx bx-plus" /></a>
                ...
                <div className="col-lg-4 col-md-6 portfolio-item filter-card">
                  <div className="portfolio-wrap">
                    <img src="./src/main/assets/img/silver/silver2.jpg" className="img-fluid" alt />
                    <div className="portfolio-info">
                      <h4>Silver Dua</h4>
                      <p>Preview</p>
                      <div className="portfolio-links">
                        <a href="./src/main/assets/img/silver/silver2.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Web 2"><i className="bx bx-plus" /></a>
                ...
                <div className="col-lg-4 col-md-6 portfolio-item filter-card">
                  <div className="portfolio-wrap">
                    <img src="./src/main/assets/img/silver/silver3.jpg" className="img-fluid" alt />
                    <div className="portfolio-info">
                      <h4>Silver Tiga</h4>
                      <p>Preview</p>
                      <div className="portfolio-links">
                        <a href="./src/main/assets/img/silver/silver3.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="App 3"><i className="bx bx-plus" /></a>
                ...
                <div className="col-lg-4 col-md-6 portfolio-item filter-web">
                  <div className="portfolio-wrap">
                    <img src="./src/main/assets/img/gold/gold1.jpg" className="img-fluid" alt />
                    <div className="portfolio-info">
                      <h4>Gold Satu</h4>
                      <p>Preview</p>
                      <div className="portfolio-links">
                        <a href="./src/main/assets/img/gold/gold1.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Card 1"><i className="bx bx-plus" /></a>
                ...
                <div className="col-lg-4 col-md-6 portfolio-item filter-web">
                  <div className="portfolio-wrap">
                    <img src="./src/main/assets/img/gold/gold2.jpg" className="img-fluid" alt />
                    <div className="portfolio-info">
                      <h4>Gold Dua</h4>
                      <p>Preview</p>
                      <div className="portfolio-links">
                        <a href="./src/main/assets/img/gold/gold2.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Card 3"><i className="bx bx-plus" /></a>
                ...
                <div className="col-lg-4 col-md-6 portfolio-item filter-web">
                  <div className="portfolio-wrap">
                    <img src="./src/main/assets/img/gold/gold3.jpg" className="img-fluid" alt />
                    <div className="portfolio-info">
                      <h4>Gold Tiga</h4>
                      <p>Preview</p>
                      <div className="portfolio-links">
                        <a href="./src/main/assets/img/gold/gold3.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Web 3"><i className="bx bx-plus" /></a>
                ...
                <div className="col-lg-4 col-md-6 portfolio-item filter-amet">
                  <div className="portfolio-wrap">
                    <img src="./src/main/assets/img/amet/AmetSatu.jpeg" className="img-fluid" alt />
                    <div className="portfolio-info">
                      <h4>Amethyst Satu</h4>
                      <p>Preview</p>
                      <div className="portfolio-links">
                        <a href="./src/main/assets/img/amet/AmetSatu.jpeg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Card 1"><i className="bx bx-plus" /></a>
                ...
                <div className="col-lg-4 col-md-6 portfolio-item filter-amet">
                  <div className="portfolio-wrap">
                    <img src="./src/main/assets/img/amet/AmetDua.jpeg" className="img-fluid" alt />
                    <div className="portfolio-info">
                      <h4>Amethyst Dua</h4>
                      <p>Preview</p>
                      <div className="portfolio-links">
                        <a href="./src/main/assets/img/amet/AmetDua.jpeg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Card 3"><i className="bx bx-plus" /></a>
                ...
                <div className="col-lg-4 col-md-6 portfolio-item filter-amet">
                  <div className="portfolio-wrap">
                    <img src="./src/main/assets/img/amet/AmetTiga.jpeg" className="img-fluid" alt />
                    <div className="portfolio-info">
                      <h4>Amethyst Tiga</h4>
                      <p>Preview</p>
                      <div className="portfolio-links">
                        <a href="./src/main/assets/img/amet/AmetTiga.jpeg" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Web 3"><i className="bx bx-plus" /></a>
  ...
  <div className="row">
    ...
    <div className="col-lg-3 col-md-6 d-flex align-items-stretch">
      <div className="member" data-aos="fade-up" data-aos-delay="100">
        <div className="member-img">
          <img src="./src/main/assets/img/team/team-1.jpg" className="img-fluid" alt="">
    ...
    <div className="col-lg-3 col-md-6 d-flex align-items-stretch">
      <div className="member" data-aos="fade-up" data-aos-delay="200">
        <div className="member-img">
          <img src="./src/main/assets/img/team/team-2.jpg" className="img-fluid" alt="">
          <div className="social">
            <a href=""><i className="bi bi-twitter"></i></a>
            <a href=""><i className="bi bi-facebook"></i></a>
            <a href=""><i className="bi bi-instagram"></i></a>
    ...
    <div className="col-lg-3 col-md-6 d-flex align-items-stretch">
      <div className="member" data-aos="fade-up" data-aos-delay="300">
        <div className="member-img">
          <img src="./src/main/assets/img/team/team-3.jpg" className="img-fluid" alt="">
          <div className="social">
            <a href=""><i className="bi bi-twitter"></i></a>
            <a href=""><i className="bi bi-facebook"></i></a>
            <a href=""><i className="bi bi-instagram"></i></a>
    ...
    <div className="col-lg-3 col-md-6 d-flex align-items-stretch">
      <div className="member" data-aos="fade-up" data-aos-delay="400">
        <div className="member-img">
          <img src="./src/main/assets/img/team/team-4.jpg" className="img-fluid" alt="">
          <div className="social">
            <a href=""><i className="bi bi-twitter"></i></a>
            <a href=""><i className="bi bi-facebook"></i></a>
            <a href=""><i className="bi bi-instagram"></i></a>
        ...
        <div className="member-info">
              ...
              <div className="row">
                <div className="col-lg-3 col-md-5">
                  <div className="box recommended" data-aos="zoom-in-right" data-aos-delay={200}>
                    ...
                    <div className="btn-wrap">
                      <a role='link' href={`https://api.whatsapp.com/send/?phone=${selectNumber}&text=Saya%20ingin%20memesan%20Paket%20Bronze.%0A%0ABagaimana%20langkah%20selanjutnya%20%3F`} target={'_blank'} className="btn-buy" rel="noreferrer">Pesan Sekarang</a>
                    </div>
                  </div>
                </div>
                <div className="col-lg-3 col-md-5 mt-4 mt-md-0">
                  <div className="box recommended" data-aos="zoom-in" data-aos-delay={100}>
                    ...
                    <div className="btn-wrap">
                      <a role='link' href={`https://api.whatsapp.com/send/?phone=${selectNumber}&text=Saya%20ingin%20memesan%20Paket%20Silver.%0A%0ABagaimana%20langkah%20selanjutnya%20%3F`} target={'_blank'} className="btn-buy" rel="noreferrer" >Pesan Sekarang</a>
                    </div>
                  </div>
                </div>
                <div className="col-lg-3 col-md-5 mt-4 mt-lg-0">
                  <div className="box recommended" data-aos="zoom-in-left" data-aos-delay={200}>
                    ...
                    <div className="btn-wrap">
                      <a role='link' href={`https://api.whatsapp.com/send/?phone=${selectNumber}&text=Saya%20ingin%20memesan%20Paket%20Gold.%0A%0ABagaimana%20langkah%20selanjutnya%20%3F`} target={'_blank'} className="btn-buy" rel="noreferrer" >Pesan Sekarang</a>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-lg-3 col-md-5 mt-4 mt-lg-0">
                  <div className="box recommended" data-aos="zoom-in-left" data-aos-delay={200}>
                    ...
                    <div className="btn-wrap">
                      <a role='link' href={`https://api.whatsapp.com/send/?phone=${selectNumber}&text=Saya%20ingin%20memesan%20Paket%20Amethyst.%0A%0ABagaimana%20langkah%20selanjutnya%20%3F`} target={'_blank'} className="btn-buy" rel="noreferrer" >Pesan Sekarang</a>
                    </div>
                  </div>
                </div>
          ...
          <section className="notification" id="fake-notification">
              ...
              <div className="info">
                ...
                <div>
                  <small>
                    ...
                    <a className="poweredby" href="https://one-times.com/" target="_blank" rel="noreferrer"><i className="fa fa-check-circle" /> Verified by Provely</a>
                  </small>
                </div>
              </div>
            </div>
            <span className="close-btn" onClick="closeNotification()">&times;</span>
          </section>
